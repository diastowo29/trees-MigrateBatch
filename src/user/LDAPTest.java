...
public class LDAPTest {
	...
	public static void main(String[] args) throws NamingException {
		...
		final String ldapAdServer = "ldap://192.168.90.140:389/";
		final String ldapSearchBase = "dc=trees,dc=co,dc=id";

		final String ldapUsername = "administrator";
		final String ldapPassword = "admin";

		final String ldapAccountToLookup = "Administrator";
